...
public interface Sampler {
     ...
     * 
     * <b>CAUTION: DO NOT DO ALLOCATION IN THIS METHOD WITHOUT ENSURING THAT THE
     * SAMPLER WILL NOT BE INVOKED ON THE RESULTING ALLOCATION.</b> Otherwise,
     * you will get an infinite regress of calls to the sampler.
     * 
     * @param count
     *            the <code>int</code> count of how many instances are being
     ...
     * @param desc
     *            the <code>String</code> descriptor of the class/primitive type
     *            being allocated.
     * @param newObj
     ...
     */
    public void sampleAllocation(int count, String desc, Object newObj,
            long size);
}
